    ...
    switch($_GET["action"]) {
        case "add":
            if(!empty($_POST["quantity"])) {
                ...
                $result = mysqli_query($connection, "SELECT * FROM monitorok WHERE code='" . $_GET["code"] . "'");
...
<section>
    <aside>
        ...
        <p><a class="c" href="monitor.php" >Monitor</a></p>
    ...
    <main style="background-image: url('img/indexhatter.jpg')">
        ...
        <div style="margin-left: 30px">
            ...
            $res = mysqli_query($connection, "SELECT * FROM monitorok ORDER BY id ASC");
            ...
            if (!empty($product_array)) {
                foreach($product_array as $key=>$value){
                    ...
                    <div class="product-item">
                        <form method="post" action="monitor.php?action=add&code=<?php echo $product_array[$key]["code"]; ?>">
