    ...
    switch($_GET["action"]) {
        case "add":
            if(!empty($_POST["quantity"])) {
                ...
                $result = mysqli_query($connection, "SELECT * FROM billentyu WHERE code='" . $_GET["code"] . "'");
...
<section>
    <aside>
        ...
        <p><a class="c" href="billentyu.php" >Billentyűzet</a></p>
    ...
    <main style="background-image: url('img/indexhatter.jpg')">
        <div id="content-box">
            <h2> Billentyűzetek </h2>
        </div> <br><br>

        <div style="margin-left: 30px">
            <?php

            $res = mysqli_query($connection, "SELECT * FROM billentyu ORDER BY id ASC");
            ...
            if (!empty($product_array)) {
                foreach($product_array as $key=>$value){
                    ...
                    <div class="product-item">
                        <form method="post" action="billentyu.php?action=add&code=<?php echo $product_array[$key]["code"]; ?>">
