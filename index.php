    ...
    switch($_GET["action"]) {
        case "add":
            if(!empty($_POST["quantity"])) {
                ...
                $result = mysqli_query($connection, "SELECT * FROM termekek WHERE code='" . $_GET["code"] . "'");
...
<nav>
    <div >
        <a class="c" id="men1" href="index.php" >Főoldal</a>
...
<section>
    ...
    <main style="background-image: url('img/indexhatter.jpg')">
        <div id="content-box">
            <h2> Üdvözöljük a honlapon, köszönjük hogy minket választott </h2>
        </div>
        <h3 style="margin-left: 30px; font-size: 20px; letter-spacing: 3px; text-decoration: underline;"> Akciós termékek: </h3>

        <div style="margin-left: 30px">
            <?php

            $res = mysqli_query($connection, "SELECT * FROM termekek ORDER BY id ASC");
